...
formLogin.addEventListener("submit", (e) => {
  ...
  firebase
    ...
    .then((userCredential) => {
      ...
      document.querySelector(".login, .background-login").style.display =
        "none";
    ...
    db.collection("registros")
      ...
      .onSnapshot((data) => {
        ...
        registros = registros.sort(function (a, b) {
          if (a.data().horario < b.data().horario) return -1;
          else return +1;
        });
        registros.map((val) => {
          ...
          list.innerHTML += `<li> 
            <div class="simplesContainer">
                ...
                <div class="excluirPonto"><a registro-id="${
                  val.id
                }" class="excluir-btn" href="javascript:void(0)"><i class="bi bi-trash"></i></a></div>
            </div>
            </li>`;
        });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var inputRegistro = document.querySelector(
    ".form-cadastro-registro [name=codigoNome]"
  );
